...
function modalHandler(modal) {
    ...
    switch (currentText) {
        ...
        case "Quiz app":
            ...
            projectDesc.innerHTML = projetos[0].quiz.replace(/(?:\r\n|\r|\n)/g, '<br>');
        ...
        case "Gerador de Box Shadow":
            projTitle.textContent = currentText;
            projectDesc.innerHTML = projetos[1].box.replace(/(?:\r\n|\r|\n)/g, '<br>');
        ...
        case "Gerador de QR CODE":
            projTitle.textContent = currentText;
            projectDesc.innerHTML = projetos[2].qr.replace(/(?:\r\n|\r|\n)/g, '<br>');
        ...
        case "Desafio Landing Page Huddle":
            projTitle.textContent = currentText;
            projectDesc.innerHTML = projetos[3].huddle.replace(/(?:\r\n|\r|\n)/g, '<br>');
        ...
        case "Hdc Host":
            projTitle.textContent = currentText;
            projectDesc.innerHTML = projetos[4].hdc.replace(/(?:\r\n|\r|\n)/g, '<br>');
